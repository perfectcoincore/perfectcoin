...
class TxnMallTest(PigeonTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 PTC:
        ...
        # First: use raw transaction API to send 1240 PTC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 PTC coin each
        ...
        # Node0's balance should be starting balance, plus 50PTC for another
        ...
        # Node0's total balance should be starting balance, plus 100PTC for
