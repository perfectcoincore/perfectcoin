    ...
    mapper(0)
{
    ...
    ui->openPerfectCoinConfButton->setToolTip(ui->openPerfectCoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new PerfectCoinUnits(this));
...
void OptionsDialog::on_openPerfectCoinConfButton_clicked()
{
    ...
    if (!GUIUtil::openPerfectCoinConf())
