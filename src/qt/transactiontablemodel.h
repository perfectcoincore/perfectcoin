...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, PerfectCoinUnits::SeparatorStyle separators=PerfectCoinUnits::separatorStandard) const;
...
#endif // PERFECTCOIN_QT_TRANSACTIONTABLEMODEL_H
