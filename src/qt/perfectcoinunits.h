...
#ifndef PERFECTCOIN_QT_PERFECTCOINUNITS_H
#define PERFECTCOIN_QT_PERFECTCOINUNITS_H
...
*/
class PerfectCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit PerfectCoinUnits(QObject *parent);

    /** Pigeon units.
      @note Source: https://en.perfectcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        PTC,
...
typedef PerfectCoinUnits::Unit PerfectCoinUnit;

#endif // PERFECTCOIN_QT_PERFECTCOINUNITS_H
