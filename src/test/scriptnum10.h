...
#ifndef PERFECTCOIN_TEST_SCRIPTNUM10_H
#define PERFECTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Pigeon Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // PERFECTCOIN_TEST_BIGNUM_H
